...
```{r Check cell population, warning = FALSE,fig.width=8, fig.height=4, dev='png'}
...
```{r Plot gating1, warning=FALSE}
plot(gs)
CytoExploreR::cyto_plot_gating_tree(gs)
```

```{r Plot gating2, warning=FALSE,fig.width=12, fig.height=6, dev='png'}
...
```{r }
palette_MarkerCounts <- scales::brewer_pal(type = "qual")(3)
